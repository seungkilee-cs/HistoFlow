...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python3 generate_test_tiles.py <image_path> <image_id>")
        print("Example: python3 generate_test_tiles.py test.jpg test-image-001")
        sys.exit(1)
    ...
    print(f"Starting tile generation for: {image_id}\n")
    ...
    print(f"  Tile: http://localhost:8080/api/v1/tiles/{image_id}/0/0_0.jpg")
